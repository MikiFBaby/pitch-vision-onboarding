...
// Extend THREE elements via global JSX
// Note: Local declaration removed as we use direct any-casting for elements below to ensure compatibility
// independent of global type merging issues.
...
// Bypassing TypeScript checks for R3F elements by using any-typed variables
const Mesh = 'mesh' as any;
const PlaneGeometry = 'planeGeometry' as any;
const CPPNShaderMaterialEl = 'cPPNShaderMaterial' as any;
...
function ShaderPlane() {
  ...
  return (
    <Mesh ref={meshRef} position={[0, -0.75, -0.5]}>
      ...
      <CPPNShaderMaterialEl ref={materialRef} side={THREE.DoubleSide} />
    </Mesh>
  );
}

// Exported as NeuralBackground for use in App.tsx layout
export function NeuralBackground() {
  ...
  return (
    <div ref={canvasRef} className="fixed inset-0 -z-50 w-full h-full bg-black" aria-hidden="true">
      <Canvas
        camera={camera}
...
export default function Hero({
  ...
  useGSAP(
    () => {
      ...
      // REMOVED SplitText to ensure compatibility without license
      // Replaced with standard opacity fade-in
  ...
  return (
    <section ref={sectionRef} className="relative h-screen w-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-start gap-6 px-6 pb-24 pt-36 sm:gap-8 sm:pt-44 md:px-10 lg:px-16 pointer-events-none">
